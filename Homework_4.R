...
?igraph.vertex.shapes # I have only two different shapes (square and circle). Need a triangle.
# I will use the code suggested by the documentation.

# first add triangle as a shape
...
# Now I have three different shapes with igraph. Plot the network with the shapes
